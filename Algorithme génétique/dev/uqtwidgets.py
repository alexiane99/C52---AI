...
class QImageViewer(QWidget):
    ...
    _default_background_brush = QBrush(QColor(64, 64, 64))
    _default_no_image_pen = QPen(QColor(128, 128, 128), 1.0, Qt.SolidLine, Qt.RoundCap, Qt.RoundJoin)
    _default_no_image_text  = "--- no image ---"
    ...
    def __init__(self, smooting_image : bool = False, parent : QWidget | None = None) -> None:
        ...
        self._background_brush = QImageViewer._default_background_brush
        self._no_image_pen = QImageViewer._default_no_image_pen
        self._no_image_text  = QImageViewer._default_no_image_text

        self.clear()

    @property
    def background_brush(self) -> QBrush:
        """La brosse de fond utilisée pour effacer le widget avant de dessiner l'image ou le texte."""
        return self._background_brush
    
    @background_brush.setter
    def background_brush(self, value : QBrush) -> None:
        self._background_brush = value
        self.update()

    @property
    def no_image_pen(self) -> QPen:
        """Le style de trait utilisé pour dessiner le texte 'no image'."""
        return self._no_image_pen
    
    @no_image_pen.setter
    def no_image_pen(self, value : QPen) -> None:
        self._no_image_pen = value
        self.update()

    @property
    def no_image_text(self) -> str:
        """Le texte affiché lorsque aucune image n'est définie."""
        return self._no_image_text
    
    @no_image_text.setter
    def no_image_text(self, value : str) -> None:
        self._no_image_text = value
        self.update()
    ...
    @image.setter
    def image(self, value : QImage | None) -> None:
        self._image = value
        self.update()
    ...
    def clear(self) -> None:
        ...
        self.image = None # call the setter
    ...
    def paint_event(self, event : QPaintEvent) -> None:
        ...
        if self._image is None or self._image.is_null():
            painter.set_pen(QImageViewer._default_no_image_pen)
            painter.draw_text(self.rect, Qt.AlignCenter, self._no_image_text)
        else:
